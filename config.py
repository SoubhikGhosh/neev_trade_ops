...
# --- Document Field Definitions with Optimized Descriptions ---
DOCUMENT_FIELDS = {
    "CRL": [
        {
            "name": "DATE & TIME OF RECEIPT OF DOCUMENT",
            "description": """Objective: Extract date and time from a circular seal stamp.
...
- Format: Combine into 'DD-MM-YYYY HH:MM'. Return null if not found."""
    ...
    "INVOICE": [
        ...
        },
        {
            ...
            "description": "Objective: Extract the method of transportation for the goods.\n- Labels: ['Ship Via', 'Mode of Shipment', 'Transport Mode', 'Carrier']\n- Content: Examples: 'Sea', 'Air', 'Road', 'Ocean'. Return null if not specified."
        },
        {
            "name": "INCO TERM",
            "description": "Objective: Extract the Incoterm and its named place.\n- Labels: ['Incoterms', 'Terms of Sale', 'Resa merce']\n- Format: Three-letter code plus location (e.g., 'EXW Scarperia', 'FOB Shanghai Port')."
        },
        {
            "name": "HS CODE",
            "description": "Objective: Extract the Harmonized System (HS/HTS) code for products.\n- Labels: ['HS Code', 'HTS Code', 'Tariff Code']\n- Location: In the line item details. If multiple, separate with a semicolon. Return null if absent."
        },
        {
            "name": "Intermediary Bank (Field 56)",
            "description": "Objective: Extract details of any intermediary/correspondent bank, if specified.\n- Labels: ['Intermediary Bank', 'Correspondent Bank', 'Field 56']\n- Note: This is an additional bank used for routing payment. Return null if not mentioned."
        },
        {
            "name": "INTERMEDIARY BANK NAME",
            "description": "Objective: Extract the name of the intermediary bank, if specified.\n- Note: Must be explicitly labeled as intermediary/correspondent."
        },
        {
            "name": "INTERMEDIARY BANK ADDRESS",
            "description": "Objective: Extract the address of the intermediary bank, if specified."
        },
        {
            "name": "INTERMEDIARY BANK COUNTRY",
            "description": "Objective: Extract the country of the intermediary bank, if specified."
        },
        {
            "name": "Party Name ( Applicant )",
            "description": "Objective: Extract the applicant's name, which is the buyer/customer.\n- Labels: ['Bill To:', 'Customer:', 'Buyer:', 'Applicant:']"
        },
        {
            "name": "Party Name ( Beneficiary )", 
            "description": "Objective: Extract the beneficiary's name, which is the seller/exporter."
        },
        {
            "name": "Party Country ( Beneficiary )", 
            "description": "Objective: Extract the beneficiary's country from their main address."
        },
        {
            "name": "Party Type ( Beneficiary Bank )", 
            "description": "Objective: Identify the role of the beneficiary's bank. Usually inferred as 'Beneficiary Bank'."
        },
        {
            "name": "Party Name ( Beneficiary Bank )",
            "description": "Objective: Extract the name of the bank holding the beneficiary's account."
        },
        {
            "name": "Party Country ( Beneficiary Bank )", 
            "description": "Objective: Extract the beneficiary bank's country. Can be inferred from the IBAN's 2-letter prefix (e.g., 'IT' -> Italy)."
        },
        {
            "name": "Drawee Address", 
            "description": "Objective: Extract the name and address of the drawee.\n- Note: If no specific drawee is named (for a bill of exchange), this defaults to the buyer's name and address."
        },
        {
            "name": "PORT OF LOADING",
            "description": "Objective: Extract the port or place where goods are loaded for export.\n- Labels: ['Port of Loading', 'POL', 'From Port', 'Place of Loading']\n- Note: For 'EXW' Incoterms, this is the seller's premises."
        },
        {
            "name": "PORT OF DISCHARGE", 
            "description": "Objective: Extract the port or place where goods are unloaded in the destination country.\n- Labels: ['Port of Discharge', 'POD', 'To Port', 'Final Destination']\n- Note: May not be present on proforma invoices. Return null if not specified."
        },
        {
            "name": "VESSEL TYPE",
            "description": "Objective: Extract the type of transport used.\n- Examples: 'Vessel', 'Aircraft', 'Truck'.\n- Note: Can be inferred from 'Mode of Transit'. Return null if not specified."
        },
        {
            "name": "VESSEL NAME", 
            "description": "Objective: Extract the specific name of the ship, flight number, or voyage number.\n- Labels: ['Vessel Name', 'Voyage No.', 'Flight No.']\n- Note: Return null if not specified."
        },
        {
            "name": "THIRD PARTY EXPORTER NAME",
            "description": "Objective: Extract the name of a third-party exporter, if they are explicitly named and are different from the seller.\n- Note: Return null if not applicable."
        },
        {
            "name": "THIRD PARTY EXPORTER COUNTRY", 
            "description": "Objective: Extract the country of the third-party exporter, if one is named.\n- Note: Return null if not applicable."
        }
    ]
}